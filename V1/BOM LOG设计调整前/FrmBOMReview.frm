...
Public Sub cmdReiew_Click()
    ...
    With MSFlexGrid1
        ...
        Do While Not myRS.EOF
            ...
            '如果当前版本有升级的话，删除本事这条记录
            StrSql = "Select ParentID FROM SglPrt4BOMLog Where ParentID=" & myRS(0) & " And ChildID=" & myRS(1) & " And chgStatus In ('Add-Upgrade','Delete-Upgrade') And BOM='" & Trim(Text1.Text) & "' And BOMVersion=" & cmbBOMVersion.Text
            If rs.State = adStateOpen Then rs.Close
            rs.Open StrSql, myCnn, adOpenKeyset, adLockPessimistic
            If rs.RecordCount = 0 Then
                ...
                .TextMatrix(i, 11) = IIf(myRS(10) = "" And myRS(7) = "Modify", lblCPCN.Caption, myRS(10))
            Else
                If myRS("ChgStatus") = "" Then
                    i = i - 1
                Else
                    .TextMatrix(i, 0) = i        '输入每行的行号
                    .TextMatrix(i, 1) = myRS(0)
...
Private Sub MSFlexGridTileInitialize()
    ...
    MSFlexGrid1.TextMatrix(0, 6) = "ItemType"
    MSFlexGrid1.TextMatrix(0, 7) = "SER NO."
    MSFlexGrid1.TextMatrix(0, 8) = "ChgStatus"
    MSFlexGrid1.TextMatrix(0, 9) = "Note"
    MSFlexGrid1.TextMatrix(0, 10) = "Family"
    MSFlexGrid1.TextMatrix(0, 11) = "CPCN"
End Sub
