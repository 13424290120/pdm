...
'    Exit Function
'  End If
   If Not Isnum(right(TxtCPCNIndex, 7)) Then  '其中Left() Right()是从左边和右边截取字符串
    MsgBox "CP/CN Series Number is 5 Letter + 7 Number" + vbCrLf + "CP/CN是5位字符 + 7位数字的编号", vbInformation, "System Info."
    TxtCPCNIndex.SetFocus
    Check = False
    Exit Function
  End If
