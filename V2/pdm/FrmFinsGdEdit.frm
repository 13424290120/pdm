...
Begin VB.Form FrmFinsGdEdit 
   ...
   Begin VB.ComboBox CombProductLine 
      Height          =   345
      ItemData        =   "FrmFinsGdEdit.frx":08CE
      Left            =   7335
      List            =   "FrmFinsGdEdit.frx":08D0
      Style           =   2  'Dropdown List
      TabIndex        =   13
      Top             =   6105
      Width           =   1410
   ...
   Begin VB.Label LblReminder 
      BackColor       =   &H0000FFFF&
      Caption         =   $"FrmFinsGdEdit.frx":08D2
      BeginProperty Font 
         Name            =   "Arial"
         Size            =   21.6
         Charset         =   0
   ...
   Begin VB.Label LblReminder1 
      Caption         =   $"FrmFinsGdEdit.frx":0917
      BeginProperty Font 
         Name            =   "Arial"
         Size            =   8.4
         Charset         =   0
   ...
   Begin VB.Label LblCommtNote 
      ...
      Height          =   375
      Left            =   1890
      MouseIcon       =   "FrmFinsGdEdit.frx":0AA1
      TabIndex        =   35
      Top             =   8490
      Width           =   3960
   End
   Begin VB.Label LblLocation 
      ...
      Height          =   375
      Left            =   1350
      MouseIcon       =   "FrmFinsGdEdit.frx":0DAB
      TabIndex        =   34
      Top             =   7695
      Width           =   4500
   End
   Begin VB.Label LblItemType 
      ...
      Height          =   375
      Left            =   1170
      MouseIcon       =   "FrmFinsGdEdit.frx":10B5
      TabIndex        =   33
      Top             =   6855
      Width           =   4680
   End
   Begin VB.Label LblPjtName 
      ...
      Height          =   375
      Left            =   1905
      MouseIcon       =   "FrmFinsGdEdit.frx":13BF
      TabIndex        =   32
      Top             =   5355
      Width           =   3915
   End
   Begin VB.Label LblPJNOIndex 
      ...
      Height          =   375
      Left            =   1620
      MouseIcon       =   "FrmFinsGdEdit.frx":16C9
      TabIndex        =   31
      Top             =   4545
      Width           =   4200
   End
   ...
   Begin VB.Label LblApplicant 
      ...
      Height          =   375
      Left            =   3480
      MouseIcon       =   "FrmFinsGdEdit.frx":19D3
      TabIndex        =   30
      Top             =   795
      Width           =   2355
   End
   ...
   Begin VB.Label LblClosDate 
      ...
      Height          =   375
      Left            =   2955
      MouseIcon       =   "FrmFinsGdEdit.frx":1CDD
      TabIndex        =   23
      Top             =   3840
      Width           =   2895
   End
   Begin VB.Label LblOpnDate 
      ...
      Height          =   375
      Left            =   2985
      MouseIcon       =   "FrmFinsGdEdit.frx":1FE7
      TabIndex        =   22
      Top             =   2985
      Width           =   2865
   End
   Begin VB.Label LblIDSO 
      ...
      Height          =   375
      Left            =   3150
      MouseIcon       =   "FrmFinsGdEdit.frx":22F1
      TabIndex        =   21
      Top             =   2145
      Width           =   2685
   End
   Begin VB.Label LblFinsGdIndex 
      ...
      Height          =   375
      Left            =   345
      MouseIcon       =   "FrmFinsGdEdit.frx":25FB
      TabIndex        =   20
      Top             =   150
      Width           =   5490
   End
   Begin VB.Label LblProductLine 
      ...
      Height          =   375
      Left            =   2340
      MouseIcon       =   "FrmFinsGdEdit.frx":2905
      TabIndex        =   19
      Top             =   6090
      Width           =   3495
   End
   Begin VB.Label LblDescription 
      ...
      Height          =   375
      Left            =   2850
      MouseIcon       =   "FrmFinsGdEdit.frx":2C0F
      TabIndex        =   18
      Top             =   1455
      Width           =   2985
   End
   Begin VB.Image Image4 
      Height          =   240
      Left            =   5868
      Picture         =   "FrmFinsGdEdit.frx":2F19
      Top             =   9408
      Width           =   240
   End
   Begin VB.Label LblCancel 
      ...
      Height          =   315
      Left            =   6465
      MouseIcon       =   "FrmFinsGdEdit.frx":3335
   ...
   Begin VB.Image Image3 
      Height          =   240
      Left            =   3588
      Picture         =   "FrmFinsGdEdit.frx":363F
      Top             =   9408
      Width           =   240
   End
   Begin VB.Label LblOK 
      ...
      Height          =   315
      Left            =   4185
      MouseIcon       =   "FrmFinsGdEdit.frx":3A5B
      MousePointer    =   99  'Custom
      TabIndex        =   16
      Top             =   9435
      Width           =   1095
