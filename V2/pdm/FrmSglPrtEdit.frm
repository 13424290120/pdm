...
Begin VB.Form FrmSglPrtEdit 
   ...
   Begin VB.ComboBox CombItemType 
      Height          =   345
      ItemData        =   "FrmSglPrtEdit.frx":08CA
      Left            =   7350
      List            =   "FrmSglPrtEdit.frx":08CC
      Style           =   2  'Dropdown List
      TabIndex        =   1
      Top             =   8235
      Width           =   1410
   ...
   Begin VB.Label LblNewOldStatus 
      ...
      Height          =   375
      Left            =   3630
      MouseIcon       =   "FrmSglPrtEdit.frx":08CE
      TabIndex        =   54
      Top             =   4140
      Width           =   2235
   End
   ...
   Begin VB.Label LblPrtUnit 
      ...
      Height          =   375
      Left            =   3225
      MouseIcon       =   "FrmSglPrtEdit.frx":0BD8
      TabIndex        =   48
      Top             =   1500
      Width           =   2625
   End
   Begin VB.Label LblSglPrtVer 
      ...
      Height          =   375
      Left            =   2220
      MouseIcon       =   "FrmSglPrtEdit.frx":0EE2
      TabIndex        =   46
      Top             =   780
      Width           =   3630
   End
   Begin VB.Label LblOK 
      ...
      Height          =   315
      Left            =   4185
      MouseIcon       =   "FrmSglPrtEdit.frx":11EC
   ...
   Begin VB.Image Image3 
      Height          =   240
      Left            =   3588
      Picture         =   "FrmSglPrtEdit.frx":14F6
      Top             =   10188
      Width           =   240
   End
   Begin VB.Label LblCancel 
      ...
      Height          =   315
      Left            =   6465
      MouseIcon       =   "FrmSglPrtEdit.frx":1912
      MousePointer    =   99  'Custom
      TabIndex        =   43
      Top             =   10215
      Width           =   1455
   ...
   Begin VB.Image Image4 
      Height          =   240
      Left            =   5868
      Picture         =   "FrmSglPrtEdit.frx":1C1C
      Top             =   10188
      Width           =   240
   End
   Begin VB.Label LblDescription 
      ...
      Height          =   375
      Left            =   2865
      MouseIcon       =   "FrmSglPrtEdit.frx":2038
      TabIndex        =   42
      Top             =   2745
      Width           =   2985
   End
   Begin VB.Label LblProductLine 
      ...
      Height          =   375
      Left            =   2355
      MouseIcon       =   "FrmSglPrtEdit.frx":2342
      TabIndex        =   41
      Top             =   7545
      Width           =   3495
   End
   Begin VB.Label LblSglPrtIndex 
      ...
      Height          =   375
      Left            =   1035
      MouseIcon       =   "FrmSglPrtEdit.frx":264C
      TabIndex        =   40
      Top             =   120
      Width           =   4815
   End
   Begin VB.Label LblIDSO 
      ...
      Height          =   375
      Left            =   3180
      MouseIcon       =   "FrmSglPrtEdit.frx":2956
      TabIndex        =   39
      Top             =   3450
      Width           =   2685
   End
   Begin VB.Label LblOpnDate 
      ...
      Height          =   375
      Left            =   3015
      MouseIcon       =   "FrmSglPrtEdit.frx":2C60
      TabIndex        =   38
      Top             =   4830
      Width           =   2865
   End
   Begin VB.Label LblClosDate 
      ...
      Height          =   375
      Left            =   2985
      MouseIcon       =   "FrmSglPrtEdit.frx":2F6A
      TabIndex        =   37
      Top             =   5505
      Width           =   2895
   End
   ...
   Begin VB.Label LblApplicant 
      ...
      Height          =   375
      Left            =   3510
      MouseIcon       =   "FrmSglPrtEdit.frx":3274
      TabIndex        =   30
      Top             =   2130
      Width           =   2355
   End
   Begin VB.Label LblReminder 
      BackColor       =   &H0000FFFF&
      Caption         =   $"FrmSglPrtEdit.frx":357E
      BeginProperty Font 
         Name            =   "Arial"
         Size            =   21.6
         Charset         =   0
   ...
   Begin VB.Label LblPJNOIndex 
      ...
      Height          =   375
      Left            =   1650
      MouseIcon       =   "FrmSglPrtEdit.frx":35C3
      TabIndex        =   28
      Top             =   6180
      Width           =   4200
   End
   Begin VB.Label LblPjtName 
      ...
      Height          =   375
      Left            =   1920
      MouseIcon       =   "FrmSglPrtEdit.frx":38CD
      TabIndex        =   27
      Top             =   6870
      Width           =   3915
   End
   Begin VB.Label LblItemType 
      ...
      Height          =   375
      Left            =   1200
      MouseIcon       =   "FrmSglPrtEdit.frx":3BD7
      TabIndex        =   26
      Top             =   8220
      Width           =   4680
   End
   Begin VB.Label LblLocation 
      ...
      Height          =   375
      Left            =   1365
      MouseIcon       =   "FrmSglPrtEdit.frx":3EE1
      TabIndex        =   25
      Top             =   8880
      Width           =   4500
   End
   Begin VB.Label LblCommtNote 
      ...
      Height          =   375
      Left            =   1905
      MouseIcon       =   "FrmSglPrtEdit.frx":41EB
      TabIndex        =   24
      Top             =   9525
      Width           =   3960
   End
