...
sMsgBox "Connection part (Cable, Plug connector,Soldering tags,Solder wires,connection plate,terminals,Leadwire)"
End Sub
...
FrmSglPrtEdit.CombItemType.Text = "???"
sMsgBox ("Wood,Damping material,Gasket,Foam,Felt,Rubber feet,texitile,cable's tie, grommet etc.")
End Sub
...
FrmSglPrtEdit.CombItemType.Text = "020"
sMsgBox "All stamped component except frame(T-Yoke, U-Yoke,Washer,Shielding pot,etc.)"
End Sub
...
sMsgBox "Damper material,Dust caps,Edges loose parts"
End Sub
...
FrmSglPrtEdit.CombItemType.Text = "050"
sMsgBox "VoiceCoil loose part(Coilformer, Insulating sleeve,VoiceCoil paper,etc.)"
End Sub
...
sMsgBox "All plastic parts for loudSpeakers,Cabinet and Boxes etc."
End Sub
